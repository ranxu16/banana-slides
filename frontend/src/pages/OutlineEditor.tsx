          ...
          <div className="flex items-center gap-2 md:gap-4 flex-shrink-0">
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-2">
                <span className="rounded-md bg-amber-50 px-2 py-1 text-xs font-semibold text-amber-700">大纲</span>
                <span className="text-sm md:text-base font-semibold text-gray-900 dark:text-foreground-primary truncate">
                  {currentProject.project_title || t('outline.title')}
                </span>
              </div>
              <div className="mt-0.5 hidden text-xs text-gray-500 md:block">
                {currentProject.pages.length} 页 · 生成大纲与章节结构
              </div>
            </div>
          </div>
